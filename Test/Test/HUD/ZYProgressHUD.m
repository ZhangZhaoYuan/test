...
+ (void)showStatus:(ZYrogressHUDStatus)status text:(NSString *)text {
    ...
    NSString *bundlePath = [[NSBundle bundleForClass:[self class]] pathForResource:@"ZYProgressHUD" ofType:@"bundle"];

    switch (status) {

        case ZYrogressHUDStatusSuccess: {
        ...
        case ZYrogressHUDStatusWaitting: {

            hud.mode = MBProgressHUDModeIndeterminate;
        }
            break;

        case ZYrogressHUDStatusInfo: {
...
+ (void)showInfoMsg:(NSString *)text {
    ...
    [self showStatus:ZYrogressHUDStatusInfo text:text];
}
...
+ (void)showFailure:(NSString *)text {
    ...
    [self showStatus:ZYrogressHUDStatusError text:text];
}

+ (void)showSuccess:(NSString *)text {

    [self showStatus:ZYrogressHUDStatusSuccess text:text];
}

+ (void)showLoading:(NSString *)text {

    [self showStatus:ZYrogressHUDStatusWaitting text:text];
}

+ (void)hide {
    
    [[ZYProgressHUD sharedHUD] setShowNow:NO];
    [[ZYProgressHUD sharedHUD] hide:YES];
}
